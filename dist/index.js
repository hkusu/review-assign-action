...
if (NODE_ENV != 'local') {
  ...
  event = {
    ...
    repository: {
      full_name: 'hkusu/assign-action',
    },
  };
  input = {
    assignees: 'hkusu',
    excludeAssignees: '',
    reviewers: 'hkusu,hoge, fuga',
    maxNumOfReviewers: '1',
    draftKeyword: 'wip',
